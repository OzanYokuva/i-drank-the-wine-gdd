...
| Turkish | `tr` | Türkçe | 🟡 In Progress | High |

### Secondary Languages (European)

| Language | Locale Code | Native Name | Status | Priority |
|----------|-------------|-------------|--------|----------|
| French | `fr` | Français | 🟡 In Progress | High |
| German | `de` | Deutsch | 🟡 In Progress | High |
| Italian | `it` | Italiano | 🟡 In Progress | Medium |
| Spanish | `es` | Español | 🟡 In Progress | Medium |
| Polish | `pl` | Polski | 🟡 In Progress | Medium |
| Russian | `ru` | Русский | 🟡 In Progress | Medium |
| Portuguese (Brazil) | `pt-BR` | Português (Brasil) | 🟡 In Progress | Medium |

### Secondary Languages (Asian)

| Language | Locale Code | Native Name | Status | Priority |
|----------|-------------|-------------|--------|----------|
| Japanese | `ja` | 日本語 | 🟡 In Progress | High |
| Korean | `ko` | 한국어 | 🟡 In Progress | Medium |
| Chinese (Simplified) | `zh-Hans` | 简体中文 | 🟡 In Progress | High |
