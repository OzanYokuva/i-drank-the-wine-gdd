...
- Heroes repeat their struggles until they see the full picture
...
- Unique backstory and perspective
- Three combat styles
...
Each city represents:
- A stage in the narrative
- A unique cultural perspective on the invasion
- Distinct visual and gameplay identity
- Connection to the larger story

**Demo City: Paris**
- Starting point of player's journey
- Represents the visible reaction to corruption
...
This GDD is a living document that will evolve as the project develops. Major changes will be logged in the [Changelog](changelog.md) with version updates.

**Related Documents:**
- [Version History](version-history.md)
- [Changelog](changelog.md)
- [Game Mechanics](../02_Game_Mechanics/)
- [Story & World](../04_Story_and_World/)
- [Characters](../03_Characters_and_Actors/)
- [Project Roadmap](../10_Project_Management/roadmap.md)
